...
public class ConsentServiceImpl implements ConsentService {
    ...
    public Map<String, String> getBalancesConsents(String consentId) {
        try {
            ...
            if(Objects.isNull(consentObj)){
                throw new ObCustomException(new ObError(ErrorCode.UK_OBIE_RESOURCE_CONSENT_MISMATCH.getErrorCode(), UUID.randomUUID().toString(), "No authorised consent found", List.of(new ObError.Description(ErrorCode.UK_OBIE_RESOURCE_CONSENT_MISMATCH.getErrorCode(), "As per TSB", "/api/v1/balances", "https://api.example.com/docs/errors/"))),"No authorised consent found");
            }
    ...
    public Map<String, String> getBalanceByIdConsents(String consentId, String accountId) {
        try {
            ...
            throw new ObCustomException(new ObError(ErrorCode.UK_OBIE_RESOURCE_CONSENT_MISMATCH.getErrorCode(), "2b5f0fb2-730b-11e8-adc0-fa7ae01bbebc", "No consent details found", List.of(new ObError.Description(ErrorCode.UK_OBIE_RESOURCE_CONSENT_MISMATCH.getErrorCode(), "As per TSB", "/api/v1/balances", "https://api.example.com/docs/errors/"))),"No consent details found");
            }
    }
