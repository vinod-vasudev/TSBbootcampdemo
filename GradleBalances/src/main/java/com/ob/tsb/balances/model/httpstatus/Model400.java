...
public class Model400 {
  ...
  private String code = "400 Bad Request";
  ...
  @Valid
  private List<@Valid Model400ErrorsInner> errors;
  ...
  */
  ...
  public Model400 errors(List<@Valid Model400ErrorsInner> errors) {
    this.errors = errors;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("Errors")
  public List<@Valid Model400ErrorsInner> getErrors() {
    return errors;
  }

  public void setErrors(List<@Valid Model400ErrorsInner> errors) {
    this.errors = errors;
  }
  ...
  public boolean equals(Object o) {
    ...
    Model400 modal400 = (Model400) o;
    return Objects.equals(this.code, modal400.code) &&
        Objects.equals(this.id, modal400.id) &&
        Objects.equals(this.message, modal400.message) &&
        Objects.equals(this.errors, modal400.errors);
  }
