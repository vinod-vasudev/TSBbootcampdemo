...
public record ConsentDto(@JsonProperty("ConsentId")String consentId, @JsonProperty("ConsentStatus")String consentStatus, @JsonProperty("Accounts")List<Accounts> accounts) {
