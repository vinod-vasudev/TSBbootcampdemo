...
public interface BalancesApi {
    ...
    default Mono<ResponseEntity<BalancesResponse>> _balances(
        ...
        return balances(authorization, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, accept, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<BalancesResponse>> balances(String authorization, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String accept,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<BalancesResponse>> _balancesById(
    ...
    // Override this method
    default  Mono<ResponseEntity<BalancesResponse>> balancesById(String accountId,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
        for (MediaType mediaType : exchange.getRequest().getHeaders().getAccept()) {
            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
