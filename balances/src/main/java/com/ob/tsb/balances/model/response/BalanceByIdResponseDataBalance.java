...
import com.ob.tsb.balances.model.response.BalanceByIdResponseDataBalanceCreditLineInner;
...
public class BalanceByIdResponseDataBalance {
  ...
  */
  ...
  public BalanceByIdResponseDataBalance dateTime(OffsetDateTime dateTime) {
