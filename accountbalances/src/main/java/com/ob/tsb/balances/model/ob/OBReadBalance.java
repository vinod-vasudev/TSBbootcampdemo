...
public record Balance(
        ...
        String AccountId,
        Amount Amount, com.ob.tsb.balances.model.constants.CreditDebitIndicator CreditDebitIndicator, String Type, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime DateTime, List<CreditLine> CreditLine){
